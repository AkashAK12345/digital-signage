...
class ScheduleService:
    ...
    @staticmethod
    def _validate_dates_and_times(start_date: str, end_date: str, start_time: str, end_time: str):
        # YYYY-MM-DD
    ...
    @staticmethod
    def _check_conflicts(db: Session, device_ids: List[str], start_date: str, end_date: str, start_time: str, end_time: str, priority: str, exclude_schedule_id: str = None):
